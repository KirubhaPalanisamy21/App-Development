  ...
  <div className="grid_4">
    <section className="box widget locations">
      ...
      <div className="details">
        ...
        <a href="#" className="btn btn-primary btn-block btn-large">
          view on maps
        </a>
      </div>
    </section>
    ...
    <div className="inner_container">
      <div className="col_1of3">
        <section className="box widget video">
          <img
            src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/6035/scrtpxls_video.png"
            alt=""
          />
        </section>
        <section className="box widget weather">
          <header className="header">
            <div className="temp">
              10° <span className="icon-brightness-half" />
            </div>
            <span className="icon-partlycloudy" />
          </header>
          <article>
      ...
      <div className="col_2of3">
        <article className="box post">
          ...
          <div className="details">
            <h2>Amsterdan</h2>
            <p>
              Amsterdam is the capital city of and the most populous within the
              Kingdom of the Netherlands. Amsterdam's name derives from
              Amstelredamme. Amsterdam is located in the western... Netherlands
            </p>
          </div>
        </article>
      </div>
        ...
        <section className="box widget audio">
          ...
          <div className="details">
            ...
            <div className="player">
              <div className="bar">
                <div className="progress" data-time="1:45" />
              </div>
